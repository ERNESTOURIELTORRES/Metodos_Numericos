...
// Clase que implementa el método del trapecio
class ResolvedorTrapecio {
    public double resolver(EntradaDatosTrapecio datos) {
        double a = datos.getA();
        double b = datos.getB();
        int n = datos.getN();
...
class SalidaResultadosTrapecio {
...
public class IntegracionTrapecio {
    public static void main(String[] args) {
        // Obtener datos
        EntradaDatosTrapecio entrada = new EntradaDatosTrapecio();
        entrada.obtenerDatos();
        
        // Resolver la integral
        ResolvedorTrapecio resolvedor = new ResolvedorTrapecio();
        double resultado = resolvedor.resolver(entrada);
        
        // Mostrar resultados
        SalidaResultadosTrapecio salida = new SalidaResultadosTrapecio();
